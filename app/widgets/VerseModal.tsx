    ...
    >
      <div className="w-full max-w-md bg-[#111] border border-white/10 rounded-xl overflow-hidden flex flex-col">
        ...
        <div className="flex gap-2 justify-end px-5 py-4 border-t border-white/5">
          <button onClick={onClose} className="px-5 py-2 text-xs tracking-[0.2em] text-white/50 border border-white/5 rounded-lg hover:bg-white/5 transition-colors capitalize">Close</button>
          <button onClick={onNext} className="px-5 py-2 text-xs tracking-[0.2em] text-white bg-white/10 border border-white/8 rounded-lg hover:bg-white/15 transition-colors capitalize">Next verse</button>
        </div>
      </div>
    </div>
  );

    ...
    >
      <div className="w-full max-w-sm bg-[#111] border border-white/5 rounded-xl overflow-hidden flex flex-col">
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/5">
          <p className="text-xs tracking-[0.3em] text-white/40 uppercase">Find Music</p>
        ...
        <div className="flex flex-col gap-2 px-5 py-4">
          {sources.map((s) => (
            ...
            >
              <div>
                <p className="text-[11px] tracking-[0.15em] text-white/60 group-hover:text-white/80 transition-colors">{s.name}</p>
                <p className="text-[10px] tracking-[0.1em] text-white/25 mt-0.5">{s.desc}</p>
              </div>
              <svg className="w-3 h-3 text-white/20 group-hover:text-white/40 shrink-0 ml-3 transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div className="px-5 pb-5">
          <p className="text-[9px] tracking-[0.15em] text-white/20 text-center leading-relaxed">

        ...
        <div className="flex flex-col gap-5 px-5 py-5">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="bg-transparent border border-white/10 rounded-lg px-3 py-2 text-sm text-white/70 tracking-[0.1em] outline-none focus:border-white/25 transition-colors"
            />
          </div>
          <div className="flex flex-col gap-1.5">

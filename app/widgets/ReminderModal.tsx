        ...
        <div className="flex-1 overflow-y-auto min-h-0 scrollbar-thin">
                ...
                if (editingId === item.id) {
                  return (
                    <div key={item.id} className="flex flex-col gap-2 px-5 py-3 bg-white/[0.03]">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => setEditingId(null)} className="flex-1 py-1.5 text-[10px] tracking-[0.15em] uppercase text-white/50 border border-white/5 rounded-lg hover:bg-white/5 transition-colors">Cancel</button>
                        <button onClick={saveEdit} disabled={!editText.trim()} className="flex-1 py-1.5 text-[10px] tracking-[0.15em] uppercase text-white/75 bg-white/8 border border-white/10 rounded-lg hover:bg-white/12 transition-colors disabled:opacity-30">Save</button>
                      </div>
                    </div>
                  );
                }
          ...
          <div className="px-5 py-4 border-t border-white/5 flex flex-col gap-3">
            ...
            <button
              onClick={addItem}
              disabled={!text.trim()}
              className="w-full py-2 text-xs tracking-[0.2em] uppercase text-white/60 hover:text-white/85 border border-white/8 hover:border-white/15 rounded-lg transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
            >
              Add
            </button>
          </div>

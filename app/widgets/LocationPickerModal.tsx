    ...
    >
      <div className="w-full max-w-md bg-[#111] border border-white/10 rounded-xl overflow-hidden flex flex-col">
        ...
        <div className="overflow-y-auto max-h-60">
          {searching && <p className="px-5 py-3 text-xs tracking-[0.2em] text-white/25">Searching…</p>}
          ...
          {!searching && query.trim().length >= 2 && results.length === 0 && (
            <p className="px-5 py-3 text-xs tracking-[0.1em] text-white/25">No results.</p>
          )}
        </div>
